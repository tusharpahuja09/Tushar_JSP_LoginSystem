<%-- 
    Document   : updatedobstep2
    Created on : Nov 5, 2014, 4:27:17 PM
    Author     : Work
--%>
...
<html>
    ...
    <body>
	    ...
	    Connection con = DriverManager.getConnection( "jdbc:mysql://localhost:3306/tushardb", "root", "admin");
            ...
            String qry="Update userinfo set DOB='"+request.getParameter("newdob")+"' where UserId='"+id+"'";
            stmt.executeUpdate(qry);
            out.println("<h3>Date Of Birth Sucessfully Changed</h3>") ;
        %>
    </body>
</html>
